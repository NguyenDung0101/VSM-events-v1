  ...
  useEffect(() => {
    ...
    const mockEvents: Event[] = [
      ...
      },
      {
        ...
        description: "Chạy vui cùng cộng đồng sinh viên Sài Gòn trong không khí thoải mái và năng động.",
        date: "2024-02-28",
      ...
      },
      {
        ...
        description: "Khám phá vẻ đẹp Đà Lạt qua từng bước chạy trên những con đường mòn thơ mộng.",
        date: "2024-04-20",
      ...
      },
      {
        ...
        description: "Chạy đêm độc đáo tại thành phố cảng với ánh đèn lung linh.",
        date: "2024-01-20",
          ...
          <div className="container mx-auto px-4">
            {filteredEvents.length === 0 ? (
              <div className="text-center py-16">
                <p className="text-xl text-muted-foreground">Không tìm thấy sự kiện nào.</p>
              </div>
            ) : (
                      ...
                      <CardContent className="space-y-4">
                        ...
                        <Button className="w-full" asChild>
                          <Link href={`/events/${event.id}`}>
                            {event.status === "upcoming" ? "Đăng ký tham gia" : "Xem chi tiết"}
                          </Link>
                        </Button>
                      </CardContent>
                    </Card>
